...
# Each backend override takes precedence over its group default.
: "${CLQR_RUN_CPU:=1}"
: "${CLQR_RUN_EXTERNAL:=1}"
...
: "${CLQR_RUN_JAX:=1}"
: "${CLQR_RUN_JAX_CPU:=$CLQR_RUN_JAX}"
: "${CLQR_RUN_JAX_GPU:=$CLQR_RUN_JAX}"
: "${CLQR_RUN_TESTS:=1}"
: "${CLQR_RUN_SANITIZERS:=1}"
: "${CLQR_RUN_ORIGINAL_TABLE:=1}"
clqr_benchmark_options=(
  CLQR_RUN_CPU CLQR_RUN_EXTERNAL CLQR_RUN_VANROYE CLQR_RUN_YANG CLQR_RUN_LAINE
  CLQR_RUN_CORRECTED_LAINE CLQR_RUN_JAX CLQR_RUN_JAX_CPU CLQR_RUN_JAX_GPU
  CLQR_RUN_TESTS CLQR_RUN_SANITIZERS
